<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\phps\PHPTutorial\WWW\tp5\public/../application/admin\view\links\add.html";i:1521717152;s:36:"../application/admin/common/top.html";i:1522767197;s:37:"../application/admin/common/left.html";i:1521689969;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>后台管理</title>
            ...
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增链接</span>
                       ...
                       <div id="horizontal-form">
                        <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                        <label for="desc" class="col-sm-2 control-label no-padding-right">链接详情</label>
                        <div class="col-sm-6">
