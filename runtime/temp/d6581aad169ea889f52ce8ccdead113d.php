<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\setup\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\add\add.html";i:1551447722;s:36:"../application/admin/common/top.html";i:1523431717;s:37:"../application/admin/common/left.html";i:1521689969;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="password" required="" placeholder="" name="password" type="text">
                                                </div>
                                                  <p class="help-block col-sm-4 red">* 必填</p>
                                                </div>
