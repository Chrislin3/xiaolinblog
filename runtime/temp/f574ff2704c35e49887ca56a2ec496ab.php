<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\setup\phpstudy\PHPTutorial\WWW\tp5\public/../application/admin\view\cate\edit.html";i:1521818963;s:36:"../application/admin/common/top.html";i:1523431717;s:37:"../application/admin/common/left.html";i:1521689969;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>后台管理</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                         <label for="catename" class="col-sm-2 control-label no-padding-right">栏目标题</label>
                            <div  class="col-sm-6">
                                <input class="form-control" id="catename" placeholder="" name="catename" value="<?php echo $cate['catename']; ?>" type="text">
                            </div>
