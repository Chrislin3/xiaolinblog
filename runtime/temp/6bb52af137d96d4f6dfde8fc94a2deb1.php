<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phps\PHPTutorial\WWW\tp5\public/../application/admin\view\article\edit.html";i:1522130711;s:36:"../application/admin/common/top.html";i:1522767197;s:37:"../application/admin/common/left.html";i:1521689969;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title>后台管理</title>
                ...
                <div id="horizontal-form">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="author" placeholder="" name="author"  value="<?php echo $article['author']; ?>" type="text">
                            </div>
                           </div>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="keywords" placeholder="" name="keywords" value="<?php echo $article['keywords']; ?>"  type="text">
                            </div>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="pic" placeholder="" name="pic" style="display: inline;" value="<?php echo $article['pic']; ?>"   type="file">
                            </div>
                        <?php if($article['pic'] != ''): ?>
                            <img src="http://127.0.0.1/tp5/public/<?php echo $article['pic']; ?>" height="50">
                                <?php else: ?>
                               <span>暂无图片</span>
                                <?php endif; ?>
                        </div>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              ...
                              <option <?php if($vo['id'] == $article['cateid']): ?> selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>" "><?php echo $vo['catename']; ?></option>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <label>
                                <input class="checkbox-slider colored-blue"  <?php if($article['state'] == 1): ?> checked="checked" <?php endif; ?> type="checkbox">                                  <span class="text"></span>
                              </label>
                            </div>
                        </div>
                         <div id="horizontal-form">
